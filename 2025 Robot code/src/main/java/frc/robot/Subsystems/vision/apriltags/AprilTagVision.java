...
public class AprilTagVision extends frc.robot.Subsystems.MapleSubsystem {
    ...
    public AprilTagVision(AprilTagVisionIO io, List<PhotonCameraProperties> camerasProperties, DriveTrain driveSubsystem) {
        super("Vision");
        this.io = io;
